...
function Box() {
    ...
    <select name="source" id="source" onChange={(e)=>setSr(e.target.value)}>{source()} </select>
                            <IconButton >  <ArrowIcon></ArrowIcon>
                            <Up/>
                            </IconButton>
                         
    <select name="destination" id="destination" onChange={(e)=>setDest(e.target.value)}>{source()}</select>

                            <input type="date"style={{border:"none",borderRadius:"6px"}} onChange={(e)=>setDate(e.target.value)}/>
                            
                            </div>
                            <div className="btn1">
                            <button className='btn' onClick={handleClick}>Find Trains</button>
                            </div>
                        </form>
                    </div>
                </div>
